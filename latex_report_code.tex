...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small\textit{Electricity Bill Minimization via LP}}
\rhead{\small\textit{BSDS, ISI Kolkata \(\cdot\) April 2026}}
\cfoot{\thepage}
...
\begin{tabular}{ll}
  ...
  \textbf{Dataset}           & \href{https://www.kaggle.com}{Kaggle Dataset}\\[4pt]
  \textbf{GitHub Repository} & \href{https://github.com}{GitHub Repository}\\[4pt]
  \textbf{R Script}          & \href{https://github.com}{R Code File}
\end{tabular}
...
\begin{enumerate}
  ...
  \item Dataset: \href{https://www.kaggle.com}{Kaggle Electricity Bill Dataset}.
  \item GitHub Repository: \href{https://github.com}{GitHub Repository}.
\end{enumerate}
